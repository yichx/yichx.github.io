...
excerpt: "I am the first co-author. This paper proposes a poisoning attack on federated recommender systems based on fake users that require no extra knowledge or local training data. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='/publication/fedrec_poison' target='_blank' style='color: #007bff; text-decoration: none; font-size: 20px;'>details...</a>"
submitted: 0
venue: 'UseNix'
date: 2023-10-15
---
* First co-author. &nbsp;I have proposed the attacking method and conducted all experiments and written the paper. &nbsp;Supervisor: Prof. Neil Zhenqiang Gong, Duke University.
